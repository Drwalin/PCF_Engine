...
inline void S3DGL::Calculate()
{
    ...
    for( unsigned int number = 0; number < triangles.size(); number++ )
    {
        ...
        //printf( "\n %f %f %f %f %f %f", vectortrianglevertex[0][0], vectortrianglevertex[0][1], vectortrianglevertex[1][0], vectortrianglevertex[1][1], vectortrianglevertex[2][0], vectortrianglevertex[2][1] );
        //printf( "\n %f %f", x_, y_ );
