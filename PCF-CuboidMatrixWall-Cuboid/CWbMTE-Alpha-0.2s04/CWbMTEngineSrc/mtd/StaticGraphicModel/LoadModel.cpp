...
//							vertices[i] = vertices[i] / scale[1];
						...
						if( scale[0] <= 0.0f && scale[1] <= 0.0f )
						{
							...
							vertices[i][1] -= scale[1] * 0.5f;
							vertices[i][2] -= scale[2] * 0.5f;
							vertices[i] = vertices[i] * scale_src[2] / scale[2];
						}
						else if( scale[0] <= 0.0f && scale[2] <= 0.0f )
						{
							vertices[i][0] -= scale[0] * 0.5f;
							vertices[i][1] -= scale[1] * 0.5f;
							vertices[i][2] -= scale[2] * 0.5f;
							vertices[i] = vertices[i] * scale_src[1] / scale[1];
						}
						else if( scale[1] <= 0.0f && scale[2] <= 0.0f )
						{
							vertices[i][0] -= scale[0] * 0.5f;
							vertices[i][1] -= scale[1] * 0.5f;
							vertices[i][2] -= scale[2] * 0.5f;
							vertices[i] = vertices[i] * scale_src[0] / scale[0];
						}
						else*/
						{
							//vertices[i] = SetVector( vertices[i][0]/scale[0], vertices[i][1]/scale[1], vertices[i][2]/scale[2] );
//							vertices[i][0] *= scale_src[0]/scale[0];
//							vertices[i][1] *= scale_src[1]/scale[1];
//							vertices[i][2] *= scale_src[2]/scale[2];
//							vertices[i][0] -= 0.5f;
//							vertices[i][1] -= 0.5f;
//							vertices[i][2] -= 0.5f;
							vertices[i][0] -= scale[0] * 0.5f;
