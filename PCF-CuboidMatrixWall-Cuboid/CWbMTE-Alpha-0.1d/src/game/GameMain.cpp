...
int main( int argc, char *argv[] )
{
    ...
    */
	...
	for( int i = 0; i < game.engine.map.staticobject.size(); i++ )
	{
		...
		game.engine.map.staticobject[i].pos.Set( 0.0f, 30.0f+float(i), 0.0f );
    ...
    #define ONETRIANGLESIZE 2.0f
    #define SIZEEEE_2 20.0f*ONETRIANGLESIZE
    #define SIZEEEE 20.0f*ONETRIANGLESIZE
    #define HEIGHT 15.0f
