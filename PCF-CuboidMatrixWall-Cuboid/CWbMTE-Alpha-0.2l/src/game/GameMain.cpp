...
int main( int argc, char *argv[] )
{
    ...
    */
	game.engine.AddGraphicModel( "Media\\StaticModels\\Tree.obj", "Media\\Textures\\Tree.bmpx", GL_LINEAR );
	game.engine.AddGraphicModel( "Media\\StaticModels\\Herobrine.obj", "Media\\Textures\\Herobrine.bmpx", GL_NEAREST );
	game.engine.AddGraphicModel( "Media\\StaticModels\\House.obj", "Media\\Textures\\House.bmpx", GL_NEAREST );
	game.engine.AddGraphicModel( "Media\\StaticModels\\Homunculus.obj", "Media\\Textures\\Homunculus.bmpx", GL_NEAREST );
	game.engine.AddGraphicModel( "Media\\StaticModels\\Barrel.obj", "Media\\Textures\\Barrel.bmpx", GL_NEAREST );
	...
	for( int i = 0; i < game.engine.map.staticobject.size(); i++ )
	{
		...
		if( i != 0 )
		{
			...
			{
			case 2:
				game.engine.map.staticobject[i].model = game.engine.GetStaticModelHandle( "Homunculus" );
				game.engine.map.staticobject[i].aabb[0].size.Set( 4.0f, 6.75f, 4.0f );
				break;
			case 3:
