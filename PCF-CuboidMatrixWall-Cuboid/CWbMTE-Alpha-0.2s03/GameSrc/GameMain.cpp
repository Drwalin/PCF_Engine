...
int main( int argc, char *argv[] )
{
	...
	*/
	...
	game.engine.AddGraphicModel( "..\\MediaPNG\\StaticModels\\BowWithArrow3.obj",	"..\\MediaPNG\\Textures\\Bow.png",				Vector(1.0f,1.0f,1.0f),			GL_NEAREST );
	...
	for( int i = 0; i < game.engine.ObjectsNumber(); i++ )
	{
		...
		if( i != 0 )
		{
			...
			case 2:
				...
				game.engine.Object(i)->aabb[0].size.Set( 2.1f, 2.3f, 2.1f );
				break;
			default:
