...
int main( int argc, char *argv[] )
{
	...
	game.engine.AddVBO( "..\\Media\\Textures\\textmodel.png", GL_LINEAR );
	
	/*
		load textures and models:
	*/
	game.engine.AddGraphicModel( "..\\Media\\StaticModels\\Tree.obj",			"..\\Media\\Textures\\Tree.png",			Vector(3.0f,0.8f,3.0f),			GL_LINEAR );
	game.engine.AddGraphicModel( "..\\Media\\StaticModels\\Herobrine.obj",		"..\\Media\\Textures\\Herobrine.png",		Vector(1.5f,1.0f,1.0f),			GL_NEAREST );
	game.engine.AddGraphicModel( "..\\Media\\StaticModels\\House.obj",			"..\\Media\\Textures\\House.png",			Vector(1.0f,1.0f,1.0f),			GL_NEAREST );
	game.engine.AddGraphicModel( "..\\Media\\StaticModels\\Barrel.obj",			"..\\Media\\Textures\\Barrel.png",			Vector(1.0f,1.0f,1.0f),			GL_NEAREST );
