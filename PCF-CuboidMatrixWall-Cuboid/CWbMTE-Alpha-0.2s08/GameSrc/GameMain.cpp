...
int main( int argc, char *argv[] )
{
	...
	*/
	...
	game.engine.AddGraphicModel( "..\\MediaPNG\\StaticModels\\House.obj",			"..\\MediaPNG\\Textures\\House.png",			Vector(1.0f,1.0f,1.0f),			GL_LINEAR );
	game.engine.AddGraphicModel( "..\\MediaPNG\\StaticModels\\Barrel.obj",			"..\\MediaPNG\\Textures\\Barrel.png",			Vector(1.0f,1.0f,1.0f),			GL_LINEAR );
	game.engine.AddGraphicModel( "..\\MediaPNG\\StaticModels\\BowWithArrow3.obj",	"..\\MediaPNG\\Textures\\Bow.png",				Vector(1.0f,1.0f,1.0f),			GL_LINEAR );
	game.engine.AddGraphicModel( "..\\MediaPNG\\StaticModels\\Weed.obj",			"..\\MediaPNG\\Textures\\Weed.png",				Vector(1.0f,1.0f,1.0f),			GL_LINEAR );
