...
inline int GetIntFromString( char * src, int id )
{
	...
	while( i < lenght && !( (unsigned char)((*(src+i))-48) < 10 && ( ( *(src+i-1) == ' ' && i > 0 ) || ( *(src+i-2) == ' ' && *(src+i-1) == '-' && i > 1 ) || i == 0 || ( i == 1 && *(src+i-1) == '-' ) ) ) )
	{
		i++;
	}
	...
	while( i < lenght )
	{
		...
		{
			pos++;
			if( (unsigned char)((*(src+i))-48) < 10 && ( ( *(src+i-1) == ' ' && i > 0 ) || ( *(src+i-2) == ' ' && *(src+i-1) == '-' && i > 1 ) || i == 0 || ( i == 1 && *(src+i-1) == '-' ) ) )
				i++;
			while( i < lenght && !( (unsigned char)((*(src+i))-48) < 10 && ( ( *(src+i-1) == ' ' && i > 0 ) || ( *(src+i-2) == ' ' && *(src+i-1) == '-' && i > 1 ) || i == 0 || ( i == 1 && *(src+i-1) == '-' ) ) ) )
			{
				i++;
