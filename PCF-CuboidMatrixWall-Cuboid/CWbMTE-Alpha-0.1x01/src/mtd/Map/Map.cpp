...
//		lightnings[i].Draw();
//	}
	if( lightnings.EndingTime > lightnings.actualTime )
		lightnings.Draw();
	...
	glEnd();
			...
			{
				glTranslatef( staticobject[i].pos[0], staticobject[i].pos[1], staticobject[i].pos[2] );
				glRotatef(  180.0f+staticobject[i].see[0], 0.0f, 1.0f, 0.0f );
				staticobject[i].model -> Draw();
				glRotatef( -180.0f-staticobject[i].see[0], 0.0f, 1.0f, 0.0f );
				glTranslatef( (0.0f-staticobject[i].pos)[0], (0.0f-staticobject[i].pos)[1], (0.0f-staticobject[i].pos)[2] );
			}
		}
