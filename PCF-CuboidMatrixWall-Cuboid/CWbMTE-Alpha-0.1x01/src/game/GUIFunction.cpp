...
//	sprintf( FPS[1], "Physic FPS:  %f", timefps[2] );
    ...
    glEnable( GL_TEXTURE_2D );
        ...
        {
			printf( "\nwfafahyufwahfukhawukfwhauifh wwa " );
//			Lightning light;
			engineInstantiation->map.lightnings.Set(//light.Set(
									...
									5.0f );
			printf( "\nwfafahyufwahfukhawukfwhauifh wwa " );
//			engineInstantiation->map.lightnings.push_back( light );
//			printf( "\nwfafahyufwahfukhawukfwhauifh wwa " );
			//engineInstantiation->map.lightnings.resize( 1 );
			//printf( "wfafahyufwahfukhawukfwhauifh wwa " );
