...
int main( int argc, char *argv[] )
{
    ...
    */
	game.engine.AddGraphicModel( "Media\\StaticModels\\Tree.obj",			"Media\\Textures\\Tree.bmpx",			Vector(3.0f,4.0f,3.0f),			GL_LINEAR );
	...
	game.engine.AddGraphicModel( "Media\\StaticModels\\Homunculus.obj",		"Media\\Textures\\Homunculus.bmpx",		Vector(1.0f,1.0f,1.0f),			GL_NEAREST );
