...
public:
	...
	int lightVertexCalculated;
	int NumberLightVertexCalculatedPerFrame;
	
	bool EnableStaticLight;
...
private:
	...
	inline void CalculateDynamicLight();
...
public:
	...
	*/
	...
	inline void StaticLightEnable();
	inline void DynamicLightEnable();
	inline void StaticLightDisable();
	inline void DynamicLightDisable();
	inline void AddLightSource( Vector origin, Vector direction, float range, float angleInConeVertex, float lightDensity );
	inline void SetLightMapEdgeLenght( float src );
	inline void SetMaximumNumberOfEdges( int src );
	inline LightSource * AddDynamicLightSource( Vector origin, Vector direction, float range, float angleInConeVertex, float lightDensity );
	inline LightSource * GetDynamicLightSourceHandle( int src );
