...
//	map->DrawShadowMap();
	...
	///////////////////////////////////////////
	///////////////////////////////////////////
	glFlush();		// nie wiem czy to musi byæ
	///////////////////////////////////////////
	///////////////////////////////////////////
	
	glReadBuffer( GL_FRONT );
	glReadPixels( 0, 0, 600, 600, GL_DEPTH_COMPONENT, GL_FLOAT, depthBufferData );
...
inline unsigned char LightSource::GetLightStrenght( Vector pos )
{
	...
	if( anglemul < angleBuffered && len < rangeBuffered && len > 0.1f )
	{
		...
		float distance = pointZposFromBuffer;
