...
//						if( vertexpos[x_+1][y_][z_] != vertexpos[x_][y_][z_] )
						{
							boolShit = tri -> PointIn( vertex[x_+1][y_][z_], vertex[x_][y_][z_] );
							printf( "%i ", (int) boolShit );
							if( boolShit == true )
							{
//									printf( "\n---aaa" );
								tri -> GetCrossPoint( vertex[x_+1][y_][z_], vertex[x_][y_][z_], &fastVec );
								if( tri -> PointIn( fastVec ) == true )
								{
...
//						if( vertexpos[x_][y_+1][z_] != vertexpos[x_][y_][z_] )
						{
							boolShit = tri -> PointIn( vertex[x_][y_+1][z_], vertex[x_][y_][z_] );
							printf( "%i ", (int) boolShit );
							if( boolShit == true )
							{
//									printf( "\n---aaa" );
								tri -> GetCrossPoint( vertex[x_][y_+1][z_], vertex[x_][y_][z_], &fastVec );
								if( tri -> PointIn( fastVec ) == true )
								{
									object->contact.AddPoint( fastVec );
								}
...
//						if( vertexpos[x_][y_][z_+1] != vertexpos[x_][y_][z_] )
						{
							boolShit = tri -> PointIn( vertex[x_][y_][z_+1], vertex[x_][y_][z_] );
							printf( "%i ", (int) boolShit );
							if( boolShit == true )
							{
//									printf( "\n---aaa" );
								tri -> GetCrossPoint( vertex[x_][y_][z_+1], vertex[x_][y_][z_], &fastVec );
								if( tri -> PointIn( fastVec ) == true )
								{
									object->contact.AddPoint( fastVec );
								}
