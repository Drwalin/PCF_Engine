...
#include"ObjectAliveClass.h"        // tylko prostopad³oœciany
#include"ObjectPhysicalClass.h"     // tylko prostopad³oœciany
#include"PhysicTriangleClass.h"     // tylko prostopad³oœciany
