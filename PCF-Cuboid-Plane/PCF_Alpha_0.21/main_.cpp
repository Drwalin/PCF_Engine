...
else
{
		...
		*/
        ...
        if( ( PLAYER.speed * SetVector( Xpoint( PLAYER.lookxz ), 0.0f, Zpoint( PLAYER.lookxz ) ) ).Lenght() < 6.0f )
        {
		  if( GetAsyncKeyState(0x57) & 0x8000 ) // 'W'
		  {
              PLAYER.force.vertex[0] += Xpoint( PLAYER.lookxz )          * PLAYE_RFORCEMOVING * ( float(PLAYER.collisiondown)*0.75f + 0.25f + float(keyboardobiect.keypressed[0x10]&&PLAYER.collisiondown)*2.0f + float(playercrouch==0) ) * 0.5f;
              PLAYER.force.vertex[2] += Zpoint( PLAYER.lookxz )          * PLAYE_RFORCEMOVING * ( float(PLAYER.collisiondown)*0.75f + 0.25f + float(keyboardobiect.keypressed[0x10]&&PLAYER.collisiondown)*2.0f + float(playercrouch==0) ) * 0.5f;
		  }
        }
        if( ( PLAYER.speed * SetVector( Xpoint( PLAYER.lookxz + 90.0f ), 0.0f, Zpoint( PLAYER.lookxz + 90.0f ) ) ).Lenght() < 6.0f )
        {
		  if( GetAsyncKeyState(0x41) & 0x8000 ) // 'A'
		  {
              PLAYER.force.vertex[0] += Xpoint( PLAYER.lookxz + 90.0f )  * PLAYE_RFORCEMOVING * ( float(PLAYER.collisiondown)*0.75f + 0.25f + float(keyboardobiect.keypressed[0x10]&&PLAYER.collisiondown)*2.0f + float(playercrouch==0) ) * 0.5f;
              PLAYER.force.vertex[2] += Zpoint( PLAYER.lookxz + 90.0f )  * PLAYE_RFORCEMOVING * ( float(PLAYER.collisiondown)*0.75f + 0.25f + float(keyboardobiect.keypressed[0x10]&&PLAYER.collisiondown)*2.0f + float(playercrouch==0) ) * 0.5f;
                
		  }
        }
        if( ( PLAYER.speed * SetVector( Xpoint( PLAYER.lookxz + 180.0f ), 0.0f, Zpoint( PLAYER.lookxz + 180.0f ) ) ).Lenght() < 6.0f )
        {
		  if( GetAsyncKeyState(0x53) & 0x8000 ) // 'S'
		  {
              PLAYER.force.vertex[0] += Xpoint( PLAYER.lookxz + 180.0f ) * PLAYE_RFORCEMOVING * ( float(PLAYER.collisiondown)*0.75f + 0.25f + float(keyboardobiect.keypressed[0x10]&&PLAYER.collisiondown)*2.0f + float(playercrouch==0) ) * 0.5f;
              PLAYER.force.vertex[2] += Zpoint( PLAYER.lookxz + 180.0f ) * PLAYE_RFORCEMOVING * ( float(PLAYER.collisiondown)*0.75f + 0.25f + float(keyboardobiect.keypressed[0x10]&&PLAYER.collisiondown)*2.0f + float(playercrouch==0) ) * 0.5f;
		  }
        }
        if( ( PLAYER.speed * SetVector( Xpoint( PLAYER.lookxz + 270.0f ), 0.0f, Zpoint( PLAYER.lookxz + 270.0f ) ) ).Lenght() < 6.0f )
        {
		  if( GetAsyncKeyState(0x44) & 0x8000 ) // 'D'
		  {
              PLAYER.force.vertex[0] += Xpoint( PLAYER.lookxz + 270.0f ) * PLAYE_RFORCEMOVING * ( float(PLAYER.collisiondown)*0.75f + 0.25f + float(keyboardobiect.keypressed[0x10]&&PLAYER.collisiondown)*2.0f + float(playercrouch==0) ) * 0.5f;
              PLAYER.force.vertex[2] += Zpoint( PLAYER.lookxz + 270.0f ) * PLAYE_RFORCEMOVING * ( float(PLAYER.collisiondown)*0.75f + 0.25f + float(keyboardobiect.keypressed[0x10]&&PLAYER.collisiondown)*2.0f + float(playercrouch==0) ) * 0.5f;
		...
		if( GetAsyncKeyState(0x11) & 0x8000 ) // CTRL
		{
            ...
            if( PLAYER.sneak == false )
            {
                PLAYER.heightlegs = 0.0f;
		...
		{
            if( PLAYER.sneak == true )
            {
                if( PLAYER.collision == false )
                {
                    PLAYER.heightlegs = 0.6;
                    PLAYER.sneak = false;
                    PLAYER.speed.vertex[1] += 0.5f;
                }
            }
