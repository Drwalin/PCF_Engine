...
void GUIFunction( float FrameTime )
{
	...
	
	{
		...
		VMatrix matrix;
		/*
		GameInstantiation->engine.Object(1)->see[0] += 0.1f;
		...
		GameInstance->engine.SegmentCollision(
							GameInstance->engine.Object(1)->pos+(GameInstance->engine.Object(1)->size*SetVector(0.5f,0.8f,0.5f)),
							GameInstance->engine.Object(1)->pos+(GameInstance->engine.Object(1)->size*SetVector(0.5f,0.8f,0.5f)) + matrix.GetVertex( SetVector( 0.0f, 0.0f, 300.0f ) ),
							&object, &triangle, GameInstance->engine.Object(1), SIGHT );
		glDepthFunc( GL_LESS );
		glLineWidth( 5.0f );
		glBegin( GL_LINES );
			glColor3f( 1.0f, 0.1f, 0.1f );
			glVertex3fv( &( ( GameInstance->engine.Object(1)->pos+(GameInstance->engine.Object(1)->size*SetVector(0.5f,0.8f,0.5f)) )[0] ) );
			glVertex3fv( &( ( GameInstance->engine.Object(1)->pos+(GameInstance->engine.Object(1)->size*SetVector(0.5f,0.8f,0.5f)) + matrix.GetVertex( SetVector( 0.0f, 0.0f, 300.0f ) ) )[0] ) );
		glEnd();
		*/
		matrix.InitEmpty();
		...
		GameInstance->engine.SegmentCollision(
							GameInstance->engine.Object(0)->pos+(GameInstance->engine.Object(0)->size*SetVector(0.5f,0.9f,0.5f)),
							GameInstance->engine.Object(0)->pos+(GameInstance->engine.Object(0)->size*SetVector(0.5f,0.9f,0.5f)) + matrix.GetVertex( SetVector( 0.0f, 0.0f, 300.0f ) ),
							&object, &triangle, GameInstance->engine.map.staticobject[0], SIGHT );
	...
	GameInstance->engine.map.particles.AddParticle( SetVector(0.0f,-5.5f,0.0f), 0.5f, SetVector(0.0f,0.0f,0.0f), SetVector(0.0f,0.01f,0.0f), 1.8f, 0, 0, 0, 30, 30, 30, 30.0f, 5.0f, 1 );
    ...
    glEnable( GL_TEXTURE_2D );
        ...
        {
			GameInstance->engine.map.particles.AddParticle(  SetVector( (GameInstance->engine.Object(0)->pos[0]+(GameInstance->engine.Object(0)->size[0]*0.5f)), (GameInstance->engine.Object(0)->pos[1]+(GameInstance->engine.Object(0)->size[1]*0.9f)), (GameInstance->engine.Object(0)->pos[2]+(GameInstance->engine.Object(0)->size[2]*0.5f)) ),
		...
		if( keyboardobiect.keypressed[GameInstance->SecondaryAttack] )
		{
			GameInstance->engine.AddLightning(
						SetVector( (GameInstance->engine.Object(0)->pos[0]+(GameInstance->engine.Object(0)->size[0]*0.5f)), (GameInstance->engine.Object(0)->pos[1]+(GameInstance->engine.Object(0)->size[1]*0.9f)), (GameInstance->engine.Object(0)->pos[2]+(GameInstance->engine.Object(0)->size[2]*0.5f)) ),
						SetVector( (GameInstance->engine.Object(0)->pos[0]+(GameInstance->engine.Object(0)->size[0]*0.5f)), (GameInstance->engine.Object(0)->pos[1]+(GameInstance->engine.Object(0)->size[1]*0.9f)), (GameInstance->engine.Object(0)->pos[2]+(GameInstance->engine.Object(0)->size[2]*0.5f)) ) + ( matrix.GetVertex(forward) * ((float((rand()%10000)-5000)/100.0f)+70.0f) ),
						25.0f, 1.0f,
						0.4f, 0.4f, 1.0f,
						0.8f, 0.8f, 1.0f,
						10,
