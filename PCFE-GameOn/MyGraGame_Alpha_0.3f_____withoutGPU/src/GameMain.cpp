...
int main( int argc, char *argv[] )
{
	...
	game.engine.StaticLightEnable();
	game.engine.DynamicLightEnable();
	
	game.engine.DestroyWorldInEngineThread();
	LoadMap();
	
	game.engine.AddDynamicLightSource( SetVector( -100, -100, -100), SetVector( 1, 1, 1 ), 100.0f, 10.0f, 1.0f );
	game.engine.AddDynamicLightSource( SetVector( 5, 10, 0 ), SetVector( 0, 0, 1 ), 200.0f, 10.0f, 0.8f );
